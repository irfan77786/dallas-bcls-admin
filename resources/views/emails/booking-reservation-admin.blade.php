...
<head>
    ...
    <title>Booking notification (admin)</title>
    ...
    <div class="container" style="max-width: 600px; margin: 0 auto; padding: 6px; background-color: #ffffff;">
        ...
        <div class="content" style="padding: 10px 4px 20px;">
            ...
            <div style="padding: 14px 16px; margin: 0 0 18px; background: linear-gradient(135deg, #faf8f3 0%, #f5f2ea 100%); border: 1px solid #e8e0d0; border-radius: 8px; font-size: 13px; color: #333;">
                ...
                <div style="white-space: pre-wrap; line-height: 1.5;">{{ $bookingData['personal_message'] }}</div>
            </div>
            @endif
            {{-- Greeting / Intro --}}
            <p style="font-size: 12px; margin: 0 0 10px;"><b>Dear team,</b></p>
            <p style="font-size: 12px; margin: 0 0 10px;">A booking was saved without payment. Details below.</p>
            <div class="admin-note" style="background-color: #fff3cd; border-left: 4px solid #9e7c1e; padding: 12px; margin: 15px 0; font-size: 15px;">
                <strong>Action:</strong> Review and follow up as needed.
            </div>

            {{-- Booker Information --}}
            @if($bookingData['isBookingForOthers'])
